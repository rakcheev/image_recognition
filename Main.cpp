...
int main(int argc, char **argv)
{
	...
	{
		rectangle(histImage1, Point(bin_w*(i - 1), hist_h), Point(bin_w*(i), hist_h - cvRound(hist.at<float>(i))),
			Scalar(255, 0, 0), 2, 8, 0);
		rectangle(histImage2, Point(bin_w*(i - 1), hist_h), Point(bin_w*(i), hist_h - cvRound(hist.at<float>(i))),
			Scalar(255, 0, 0), 2, 8, 0);
	}
	...
	line(histImage1, Point(threshold_huang2 * 2, 0), Point(threshold_huang2 * 2, hist_h), Scalar(0, 255, 0), 2, 5, 0);
	line(histImage2, Point(threshold_yen * 2, 0), Point(threshold_yen * 2, hist_h), Scalar(0, 255, 0), 2, 5, 0);
